...
$opt_name = 'fort_redux';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'CNtech', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'CNtech', 'your-textdomain-here' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Наименование и логотип', 'your-textdomain-here' ),
		'id'               => 'basic-text',
		'subsection'       => true,
		...
		'fields'           => array(
			array(
				...
				'type'     => 'media',
				'title'    => esc_html__( 'Логотип', 'your-textdomain-here' ),
				'subtitle' => esc_html__( 'Загрузите картинку логотипа', 'your-textdomain-here' ),
				'url'      => false,
				'preview'  => true,
			),
			array(
				'id'       => 'text-name',
				'type'     => 'text',
				'title'    => esc_html__( 'Наименование в шапке главной страницы и подвале сайта', 'your-textdomain-here' ),
			),
		),
	)
);
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Социальные иконки', 'your-textdomain-here' ),
		'id'         => 'social-slides',
		'icon'             => 'el el-home',
		'fields'     => array(
			array(
				'id'          => 'opt-slides',
				'type'        => 'slides',
				'title'       => esc_html__( 'Ссылки социальных сетей и мессенджеров', 'your-textdomain-here' ),
				'placeholder' => array(
					'title'       => esc_html__( 'Название', 'your-textdomain-here' ),
					'description' => esc_html__( 'Идентификатор', 'your-textdomain-here' ),
					'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
				),
			),
		),
	)
...
Redux::set_section(
	$opt_name,
	array(
		'title'      => esc_html__( 'Иконки футере', 'your-textdomain-here' ),
		'id'         => 'social-slides-footer',
		'icon'             => 'el el-home',
		'fields'     => array(
			array(
				'id'          => 'opt-slides-footer',
				'type'        => 'slides',
				'title'       => esc_html__( 'Ссылки социальных сетей', 'your-textdomain-here' ),
				'placeholder' => array(
					'title'       => esc_html__( 'Название', 'your-textdomain-here' ),
					'description' => esc_html__( '', 'your-textdomain-here' ),
					'url'         => esc_html__( 'Ссылка', 'your-textdomain-here' ),
				),
			),
		),
